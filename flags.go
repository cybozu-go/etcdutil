...
func (c *Config) AddFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&c.Prefix, "etcd-prefix", "", "prefix for etcd keys")
	fs.StringVar(&c.Timeout, "etcd-timeout", DefaultTimeout, "dial timeout to etcd")
